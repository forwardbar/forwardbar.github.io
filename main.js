...
var map = {
	"./android-chrome-144x144.png": 25,
	"./apple-touch-icon.png": 26,
	"./favicon-16x16.png": 27,
	"./favicon-32x32.png": 28,
	"./favicon.ico": 29,
...
const reqFavicons = __webpack_require__(24);
...
window.addEventListener('scroll', () => {
  const bottomOfLogo = pageHeroLogo.offsetTop - pageHeroLogo.clientHeight / 2 - 30;
...
carousels.forEach(carousel => {
  ...
  const siema = new siema_min_default.a({
    selector: track,
    duration: 400,
